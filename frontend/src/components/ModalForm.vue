...
<template>
    <div class="absolute bg-gray-900/60 z-[500] w-full h-full top-0">
        <div class="fixed  rounded-md shadow-xl bg-slate-800 w-[400px] h-max inset-x-1/2 translate-x-[-50%] top-40">
            ...
            <div class="w-full py-3 text-center bg-gray-500 rounded-t-md">
                <label class="text-[18px] text-gray-900 font-semibold ">Describe your regex</label>
